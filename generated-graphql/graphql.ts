...
export enum PostOrderByInput {
  ...
  FEATUREDPOST_ASC = 'featuredPost_ASC',
  FEATUREDPOST_DESC = 'featuredPost_DESC',
  ID_ASC = 'id_ASC',
  ID_DESC = 'id_DESC',
  PUBLISHEDAT_ASC = 'publishedAt_ASC',
  PUBLISHEDAT_DESC = 'publishedAt_DESC',
...
export type GetRecentedPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, createdAt: any, slug: string, featuredImage: { __typename?: 'Asset', url: string } }> };
...
export const GetRecentedPostsDocument = gql`
...
/**
 * __useGetRecentedPostsQuery__
 *
 * To run a query within a React component, call `useGetRecentedPostsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetRecentedPostsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetRecentedPostsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetRecentedPostsQuery(baseOptions?: Apollo.QueryHookOptions<GetRecentedPostsQuery, GetRecentedPostsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecentedPostsQuery, GetRecentedPostsQueryVariables>(GetRecentedPostsDocument, options);
      }
export function useGetRecentedPostsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecentedPostsQuery, GetRecentedPostsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecentedPostsQuery, GetRecentedPostsQueryVariables>(GetRecentedPostsDocument, options);
        }
export type GetRecentedPostsQueryHookResult = ReturnType<typeof useGetRecentedPostsQuery>;
export type GetRecentedPostsLazyQueryHookResult = ReturnType<typeof useGetRecentedPostsLazyQuery>;
export type GetRecentedPostsQueryResult = Apollo.QueryResult<GetRecentedPostsQuery, GetRecentedPostsQueryVariables>;
