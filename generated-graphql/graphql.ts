...
export type GetPostDetailsQuery = { __typename?: 'Query', post?: { __typename?: 'Post', createdAt: any, slug: string, title: string, excerpt: string, author?: { __typename?: 'Author', bio?: string | null, name: string, id: string, photo?: { __typename?: 'Asset', url: string } | null } | null, featuredImage: { __typename?: 'Asset', url: string }, categories: Array<{ __typename?: 'Category', name: string, slug: string }>, content: { __typename?: 'PostContentRichText', markdown: string } } | null };
